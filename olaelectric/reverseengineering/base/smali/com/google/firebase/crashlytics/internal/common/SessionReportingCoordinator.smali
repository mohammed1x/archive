...
.method public static synthetic b(Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator;Lg4/g;)Z
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator;->onReportSendComplete(Lg4/g;)Z
...
.method private static convertApplicationExitInfo(Landroid/app/ApplicationExitInfo;)Lcom/google/firebase/crashlytics/internal/model/CrashlyticsReport$ApplicationExitInfo;
    ...
    .line 67
    invoke-static {p0}, Lc1/e;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    .line 75
    invoke-static {p0}, Lc1/f;->a(Landroid/app/ApplicationExitInfo;)J
...
.method private findRelevantApplicationExitInfo(Ljava/lang/String;Ljava/util/List;)Landroid/app/ApplicationExitInfo;
    ...
    .line 22
    invoke-static {p2}, LX/f;->a(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;
    ...
    .line 26
    invoke-static {p2}, Lc1/f;->a(Landroid/app/ApplicationExitInfo;)J
    ...
    .line 35
    :cond_0
    invoke-static {p2}, Lc1/e;->a(Landroid/app/ApplicationExitInfo;)I
...
.method private onReportSendComplete(Lg4/g;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public sendReports(Ljava/util/concurrent/Executor;)Lg4/g;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator;->sendReports(Ljava/util/concurrent/Executor;Ljava/lang/String;)Lg4/g;
...
.method public sendReports(Ljava/util/concurrent/Executor;Ljava/lang/String;)Lg4/g;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_1
    invoke-virtual {v3, v2, v4}, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->enqueueReport(Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;Z)Lg4/g;

    move-result-object v2

    new-instance v3, LH2/O;

    invoke-direct {v3, p0}, LH2/O;-><init>(Ljava/lang/Object;)V

    .line 9
    invoke-virtual {v2, p1, v3}, Lg4/g;->h(Ljava/util/concurrent/Executor;Lg4/a;)Lg4/g;
    ...
    .line 11
    :cond_3
    invoke-static {v1}, Lg4/j;->f(Ljava/util/List;)Lg4/C;
