...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    .line 9
    iput-object v0, p0, Lcom/google/firebase/crashlytics/internal/common/CrashlyticsBackgroundWorker;->tail:Lg4/g;
...
.method private ignoreResult(Lg4/g;)Lg4/g;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private newContinuation(Ljava/util/concurrent/Callable;)Lg4/a;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public submit(Ljava/lang/Runnable;)Lg4/g;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0}, Lcom/google/firebase/crashlytics/internal/common/CrashlyticsBackgroundWorker;->submit(Ljava/util/concurrent/Callable;)Lg4/g;
...
.method public submit(Ljava/util/concurrent/Callable;)Lg4/g;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 3
    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/crashlytics/internal/common/CrashlyticsBackgroundWorker;->tail:Lg4/g;
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/crashlytics/internal/common/CrashlyticsBackgroundWorker;->newContinuation(Ljava/util/concurrent/Callable;)Lg4/a;

    move-result-object p1

    invoke-virtual {v1, v2, p1}, Lg4/g;->h(Ljava/util/concurrent/Executor;Lg4/a;)Lg4/g;

    move-result-object p1

    .line 4
    invoke-direct {p0, p1}, Lcom/google/firebase/crashlytics/internal/common/CrashlyticsBackgroundWorker;->ignoreResult(Lg4/g;)Lg4/g;

    move-result-object v1

    iput-object v1, p0, Lcom/google/firebase/crashlytics/internal/common/CrashlyticsBackgroundWorker;->tail:Lg4/g;
...
.method public submitTask(Ljava/util/concurrent/Callable;)Lg4/g;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 12
    invoke-virtual {v1, v2, p1}, Lg4/g;->j(Ljava/util/concurrent/Executor;Lg4/a;)Lg4/g;
