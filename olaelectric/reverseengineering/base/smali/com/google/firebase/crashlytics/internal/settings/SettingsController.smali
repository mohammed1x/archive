...
.method private logSettings(Lorg/json/JSONObject;Ljava/lang/String;)V
    ...
    .line 5
    invoke-static {p2}, LD/r;->b(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public getSettingsAsync()Lg4/g;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public loadSettingsData(Lcom/google/firebase/crashlytics/internal/settings/SettingsCacheBehavior;Ljava/util/concurrent/Executor;)Lg4/g;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2, p1}, Lg4/h;->d(Ljava/lang/Object;)V
    ...
    .line 12
    invoke-virtual {p1, p2}, Lcom/google/firebase/crashlytics/internal/common/DataCollectionArbiter;->waitForDataCollectionPermission(Ljava/util/concurrent/Executor;)Lg4/g;
    ...
    .line 13
    invoke-virtual {p1, p2, v0}, Lg4/g;->r(Ljava/util/concurrent/Executor;Lg4/f;)Lg4/g;
...
.method public loadSettingsData(Ljava/util/concurrent/Executor;)Lg4/g;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/firebase/crashlytics/internal/settings/SettingsController;->loadSettingsData(Lcom/google/firebase/crashlytics/internal/settings/SettingsCacheBehavior;Ljava/util/concurrent/Executor;)Lg4/g;
